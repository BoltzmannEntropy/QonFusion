...
def get_conf():
    initialize(version_base=None,config_path='conf', job_name="quniform_config.yaml")
    cfg = compose(config_name="quniform_config")
    return cfg
...
if __name__ == '__main__':
    ...
    for qub in (2,3,4,6):
        q = QuantumRandomUniformGenerator(cfg, qub, False)
        q.run(n_samples)
